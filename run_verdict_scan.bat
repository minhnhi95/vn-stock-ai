...
REM  cho ro VN100 + ma dang giu + ma dang dat canh bao.
REM
...
REM
REM  Mat khoang 20-25 phut: vnstock free tier chi cho 20 request/phut nen
REM  job nghi 9 giay giua moi ma. Luot quet hong (mat mang, qua nua so ma
